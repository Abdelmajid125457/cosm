<?php
/**
 * Premium checkout payment section.
 *
 * @package Theme_Perso
 * @version 9.8.0
 */
...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		...
		<p class="checkout-secure-note">
			...
			<strong><?php esc_html_e( 'Paiement 100 % sécurisé', 'theme-perso' ); ?></strong>
			<small><?php esc_html_e( 'Vos données sont protégées et chiffrées (SSL).', 'theme-perso' ); ?></small>
		</p>
