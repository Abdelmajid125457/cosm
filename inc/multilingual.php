...
function theme_perso_multilingual_text_map() {
    return array(
        ...
        'Présentation du produit' => array( 'en' => 'Product presentation', 'es' => 'Presentación del producto', 'ar' => 'عرض المنتج' ),
        'Soin COSM’ÉTHIQUE' => array( 'en' => 'COSM’ÉTHIQUE care', 'es' => 'Cuidado COSM’ÉTHIQUE', 'ar' => 'عناية كوزم إيثيك' ),
        'Note moyenne %1$s sur 5' => array( 'en' => 'Average rating %1$s out of 5', 'es' => 'Nota media %1$s sobre 5', 'ar' => 'متوسط التقييم %1$s من 5' ),
        '%s avis client' => array( 'en' => '%s customer review', 'es' => '%s opinión de cliente', 'ar' => '%s رأي عميل' ),
        '%s avis clients' => array( 'en' => '%s customer reviews', 'es' => '%s opiniones de clientes', 'ar' => '%s آراء العملاء' ),
        'Disponible' => array( 'en' => 'Available', 'es' => 'Disponible', 'ar' => 'متاح' ),
        'Rupture temporaire' => array( 'en' => 'Temporarily out of stock', 'es' => 'Agotado temporalmente', 'ar' => 'غير متوفر مؤقتاً' ),
        'Expédition 24–72h' => array( 'en' => 'Ships in 24–72h', 'es' => 'Envío en 24–72h', 'ar' => 'الشحن خلال 24–72 ساعة' ),
        'Paiement sécurisé' => array( 'en' => 'Secure payment', 'es' => 'Pago seguro', 'ar' => 'دفع آمن' ),
        'Livraison' => array( 'en' => 'Delivery', 'es' => 'Entrega', 'ar' => 'التوصيل' ),
        'Expédition sous 24 à 72 h' => array( 'en' => 'Ships within 24 to 72h', 'es' => 'Envío en 24 a 72 h', 'ar' => 'الشحن خلال 24 إلى 72 ساعة' ),
        'Retour sous 30 jours' => array( 'en' => '30-day returns', 'es' => 'Devolución en 30 días', 'ar' => 'إرجاع خلال 30 يوماً' ),
        'Le produit en détail' => array( 'en' => 'Product details', 'es' => 'El producto en detalle', 'ar' => 'تفاصيل المنتج' ),
        'Une formule pensée pour votre rituel.' => array( 'en' => 'A formula designed for your ritual.', 'es' => 'Una fórmula pensada para tu ritual.', 'ar' => 'تركيبة مصممة لروتينك.' ),
        'Pourquoi ce soin ?' => array( 'en' => 'Why this care product?', 'es' => '¿Por qué este cuidado?', 'ar' => 'لماذا هذا المنتج؟' ),
        'Pour quel type de peau ?' => array( 'en' => 'For which skin type?', 'es' => '¿Para qué tipo de piel?', 'ar' => 'لأي نوع بشرة؟' ),
        'Pour quel type de cheveux ?' => array( 'en' => 'For which hair type?', 'es' => '¿Para qué tipo de cabello?', 'ar' => 'لأي نوع شعر؟' ),
        'Ses bénéfices' => array( 'en' => 'Benefits', 'es' => 'Sus beneficios', 'ar' => 'فوائده' ),
        'Sa texture' => array( 'en' => 'Texture', 'es' => 'Su textura', 'ar' => 'قوامه' ),
        'Son parfum' => array( 'en' => 'Scent', 'es' => 'Su perfume', 'ar' => 'رائحته' ),
        'Son utilisation' => array( 'en' => 'How to use it', 'es' => 'Su uso', 'ar' => 'طريقة استخدامه' ),
        'Routine beauté' => array( 'en' => 'Beauty routine', 'es' => 'Rutina de belleza', 'ar' => 'روتين الجمال' ),
        'Comment l’utiliser' => array( 'en' => 'How to use it', 'es' => 'Cómo usarlo', 'ar' => 'كيفية استخدامه' ),
        'Nettoyer' => array( 'en' => 'Cleanse', 'es' => 'Limpiar', 'ar' => 'تنظيف' ),
        'Cibler' => array( 'en' => 'Target', 'es' => 'Tratar', 'ar' => 'استهداف' ),
        'Hydrater' => array( 'en' => 'Hydrate', 'es' => 'Hidratar', 'ar' => 'ترطيب' ),
        'Préparer' => array( 'en' => 'Prepare', 'es' => 'Preparar', 'ar' => 'تحضير' ),
        'Masser' => array( 'en' => 'Massage', 'es' => 'Masajear', 'ar' => 'تدليك' ),
        'Protéger' => array( 'en' => 'Protect', 'es' => 'Proteger', 'ar' => 'حماية' ),
        'Nourrir' => array( 'en' => 'Nourish', 'es' => 'Nutrir', 'ar' => 'تغذية' ),
        'Sublimer' => array( 'en' => 'Enhance', 'es' => 'Sublimar', 'ar' => 'إبراز الجمال' ),
        'Produits complémentaires' => array( 'en' => 'Complementary products', 'es' => 'Productos complementarios', 'ar' => 'منتجات مكملة' ),
        'Tous' => array( 'en' => 'All', 'es' => 'Todos', 'ar' => 'الكل' ),
        'Texture' => array( 'en' => 'Texture', 'es' => 'Textura', 'ar' => 'القوام' ),
        'Résultats' => array( 'en' => 'Results', 'es' => 'Resultados', 'ar' => 'النتائج' ),
        ...
        'Retrouvez vos commandes, votre diagnostic personnalisé, vos favoris et une expérience pensée pour votre routine beauté.' => array( 'en' => 'Find your orders, personalised diagnostic, favourites and an experience designed around your beauty routine.', 'es' => 'Encuentra tus pedidos, diagnóstico personalizado, favoritos y una experiencia pensada para tu rutina de belleza.', 'ar' => 'اعثر على طلباتك وتشخيصك الشخصي ومفضلاتك وتجربة مصممة لروتين جمالك.' ),
        'Routine beauté COSM’ÉTHIQUE' => array( 'en' => 'COSM’ÉTHIQUE beauty routine', 'es' => 'Rutina de belleza COSM’ÉTHIQUE', 'ar' => 'روتين جمال كوزم إيثيك' ),
        'Vos données et commandes restent protégées.' => array( 'en' => 'Your data and orders remain protected.', 'es' => 'Tus datos y pedidos permanecen protegidos.', 'ar' => 'تبقى بياناتك وطلباتك محمية.' ),
        'Suivi de livraison' => array( 'en' => 'Delivery tracking', 'es' => 'Seguimiento de entrega', 'ar' => 'تتبع التسليم' ),
        'Origine naturelle' => array( 'en' => 'Natural origin', 'es' => 'Origen natural', 'ar' => 'أصل طبيعي' ),
        'Paiement protégé' => array( 'en' => 'Protected payment', 'es' => 'Pago protegido', 'ar' => 'دفع محمي' ),
        'Commandes et factures centralisées' => array( 'en' => 'Centralised orders and invoices', 'es' => 'Pedidos y facturas centralizados', 'ar' => 'طلبات وفواتير مركزية' ),
        'Diagnostic beauté sauvegardé' => array( 'en' => 'Saved beauty diagnostic', 'es' => 'Diagnóstico de belleza guardado', 'ar' => 'تشخيص جمال محفوظ' ),
        'Favoris et recommandations personnalisés' => array( 'en' => 'Favourites and personalised recommendations', 'es' => 'Favoritos y recomendaciones personalizadas', 'ar' => 'مفضلات وتوصيات شخصية' ),
        'Créer un compte' => array( 'en' => 'Create an account', 'es' => 'Crear una cuenta', 'ar' => 'إنشاء حساب' ),
        'Créer mon compte' => array( 'en' => 'Create my account', 'es' => 'Crear mi cuenta', 'ar' => 'إنشاء حسابي' ),
        'Se connecter' => array( 'en' => 'Sign in', 'es' => 'Iniciar sesión', 'ar' => 'تسجيل الدخول' ),
        'Continuer avec Google' => array( 'en' => 'Continue with Google', 'es' => 'Continuar con Google', 'ar' => 'المتابعة باستخدام Google' ),
        ...
        'Connexion' => array( 'en' => 'Sign in', 'es' => 'Conexión', 'ar' => 'تسجيل الدخول' ),
        'Choisir une action' => array( 'en' => 'Choose an action', 'es' => 'Elegir una acción', 'ar' => 'اختر إجراءً' ),
        ...
        'La clé Apple Sign In est invalide.' => array( 'en' => 'The Apple Sign In key is invalid.', 'es' => 'La clave de Apple Sign In no es válida.', 'ar' => 'مفتاح تسجيل الدخول عبر Apple غير صالح.' ),
        'La connexion sociale n’a pas pu être validée.' => array( 'en' => 'Social login could not be verified.', 'es' => 'No se pudo validar el inicio de sesión social.', 'ar' => 'تعذر التحقق من تسجيل الدخول الاجتماعي.' ),
        'Votre compte social ne fournit pas d’adresse e-mail valide.' => array( 'en' => 'Your social account does not provide a valid email address.', 'es' => 'Tu cuenta social no proporciona un correo válido.', 'ar' => 'لا يوفر حسابك الاجتماعي بريداً إلكترونياً صالحاً.' ),
        'La connexion sociale a expiré. Merci de réessayer.' => array( 'en' => 'The social login session has expired. Please try again.', 'es' => 'La sesión de inicio social ha caducado. Inténtalo de nuevo.', 'ar' => 'انتهت صلاحية جلسة تسجيل الدخول الاجتماعي. يرجى المحاولة مرة أخرى.' ),
        'Connexion réussie. Bienvenue dans votre espace beauté.' => array( 'en' => 'Login successful. Welcome to your beauty space.', 'es' => 'Inicio de sesión correcto. Bienvenida a tu espacio belleza.', 'ar' => 'تم تسجيل الدخول بنجاح. مرحباً بك في مساحة الجمال.' ),
        'Trop de tentatives de connexion. Merci de patienter quelques minutes avant de réessayer.' => array( 'en' => 'Too many login attempts. Please wait a few minutes before trying again.', 'es' => 'Demasiados intentos de conexión. Espera unos minutos antes de volver a intentarlo.', 'ar' => 'محاولات تسجيل دخول كثيرة جداً. يرجى الانتظار بضع دقائق قبل المحاولة مرة أخرى.' ),
        ...
        'Merci d’indiquer votre prénom.' => array( 'en' => 'Please enter your first name.', 'es' => 'Indica tu nombre.', 'ar' => 'يرجى إدخال اسمك الأول.' ),
        'Merci d’indiquer votre nom.' => array( 'en' => 'Please enter your last name.', 'es' => 'Indica tu apellido.', 'ar' => 'يرجى إدخال اسم العائلة.' ),
        'Votre mot de passe doit contenir au moins 8 caractères, une majuscule, une minuscule et un chiffre.' => array( 'en' => 'Your password must contain at least 8 characters, one uppercase letter, one lowercase letter and one number.', 'es' => 'Tu contraseña debe contener al menos 8 caracteres, una mayúscula, una minúscula y un número.', 'ar' => 'يجب أن تحتوي كلمة المرور على 8 أحرف على الأقل، وحرف كبير، وحرف صغير، ورقم.' ),
        'La confirmation du mot de passe ne correspond pas.' => array( 'en' => 'The password confirmation does not match.', 'es' => 'La confirmación de contraseña no coincide.', 'ar' => 'تأكيد كلمة المرور غير مطابق.' ),
        'Vous devez accepter les Conditions Générales pour créer un compte.' => array( 'en' => 'You must accept the Terms and Conditions to create an account.', 'es' => 'Debes aceptar las Condiciones Generales para crear una cuenta.', 'ar' => 'يجب قبول الشروط والأحكام لإنشاء حساب.' ),
        'Vous devez accepter la Politique de confidentialité pour créer un compte.' => array( 'en' => 'You must accept the Privacy Policy to create an account.', 'es' => 'Debes aceptar la Política de privacidad para crear una cuenta.', 'ar' => 'يجب قبول سياسة الخصوصية لإنشاء حساب.' ),
        'Mes commandes' => array( 'en' => 'My orders', 'es' => 'Mis pedidos', 'ar' => 'طلباتي' ),
        'Mes adresses' => array( 'en' => 'My addresses', 'es' => 'Mis direcciones', 'ar' => 'عناويني' ),
        'Mes informations personnelles' => array( 'en' => 'My personal information', 'es' => 'Mi información personal', 'ar' => 'معلوماتي الشخصية' ),
        'Déconnexion' => array( 'en' => 'Log out', 'es' => 'Cerrar sesión', 'ar' => 'تسجيل الخروج' ),
        ...
        'Connectez-vous ou créez votre compte client en quelques instants.' => array( 'en' => 'Sign in or create your customer account in just a few moments.', 'es' => 'Conéctate o crea tu cuenta cliente en unos instantes.', 'ar' => 'سجل الدخول أو أنشئ حساب العميل خلال لحظات.' ),
        ...
        'Questions fréquentes Cosm’Éthique' => array( 'en' => 'Cosm’Éthique frequently asked questions', 'es' => 'Preguntas frecuentes Cosm’Éthique', 'ar' => 'الأسئلة الشائعة لكوزم إيثيك' ),
        'COSM’ÉTHIQUE' => array( 'en' => 'COSM’ÉTHIQUE', 'es' => 'COSM’ÉTHIQUE', 'ar' => 'COSM’ÉTHIQUE' ),
        'Présentation des engagements Cosm’Éthique' => array( 'en' => 'Cosm’Éthique commitments presentation', 'es' => 'Presentación de los compromisos Cosm’Éthique', 'ar' => 'عرض التزامات كوزم إيثيك' ),
        'Une beauté plus responsable, pensée pour respecter la peau, les gestes du quotidien et les choix qui comptent vraiment.' => array( 'en' => 'More responsible beauty, designed to respect skin, everyday rituals and the choices that truly matter.', 'es' => 'Una belleza más responsable, pensada para respetar la piel, los gestos cotidianos y las elecciones que de verdad importan.', 'ar' => 'جمال أكثر مسؤولية، مصمم لاحترام البشرة وطقوس الحياة اليومية والاختيارات التي تهم حقاً.' ),
        'Packaging responsable' => array( 'en' => 'Responsible packaging', 'es' => 'Packaging responsable', 'ar' => 'تغليف مسؤول' ),
        'ENGAGEMENTS' => array( 'en' => 'COMMITMENTS', 'es' => 'COMPROMISOS', 'ar' => 'التزامات' ),
        'Une exigence visible jusque dans les détails.' => array( 'en' => 'High standards visible down to the details.', 'es' => 'Una exigencia visible hasta en los detalles.', 'ar' => 'معايير عالية تظهر حتى في التفاصيل.' ),
        'naturel' => array( 'en' => 'natural', 'es' => 'natural', 'ar' => 'طبيعي' ),
        'fabrication suivie' => array( 'en' => 'monitored manufacturing', 'es' => 'fabricación controlada', 'ar' => 'تصنيع مُتابع' ),
        'Présentation des ingrédients Cosm’Éthique' => array( 'en' => 'Cosm’Éthique ingredients presentation', 'es' => 'Presentación de los ingredientes Cosm’Éthique', 'ar' => 'عرض مكونات كوزم إيثيك' ),
        'Une bibliothèque d’actifs naturels sélectionnés pour leur sensorialité, leur efficacité et leur cohérence avec chaque routine.' => array( 'en' => 'A library of natural active ingredients selected for their sensoriality, effectiveness and relevance to each routine.', 'es' => 'Una biblioteca de activos naturales seleccionados por su sensorialidad, eficacia y coherencia con cada rutina.', 'ar' => 'مكتبة من المكونات الطبيعية الفعالة المختارة لحسّيتها وفعاليتها وانسجامها مع كل روتين.' ),
        'Explorer les actifs' => array( 'en' => 'Explore active ingredients', 'es' => 'Explorar los activos', 'ar' => 'استكشاف المكونات الفعالة' ),
        'Ingrédients naturels et soins Cosm’Éthique' => array( 'en' => 'Natural ingredients and Cosm’Éthique skincare', 'es' => 'Ingredientes naturales y cuidados Cosm’Éthique', 'ar' => 'مكونات طبيعية وعناية كوزم إيثيك' ),
        'ACTIFS NATURELS' => array( 'en' => 'NATURAL ACTIVES', 'es' => 'ACTIVOS NATURALES', 'ar' => 'مكونات طبيعية فعالة' ),
        'Des ingrédients lisibles, beaux et utiles.' => array( 'en' => 'Clear, beautiful and useful ingredients.', 'es' => 'Ingredientes claros, bellos y útiles.', 'ar' => 'مكونات واضحة وجميلة ومفيدة.' ),
        'actifs clés' => array( 'en' => 'key actives', 'es' => 'activos clave', 'ar' => 'مكونات فعالة رئيسية' ),
        'univers de soin' => array( 'en' => 'care universes', 'es' => 'universos de cuidado', 'ar' => 'عوالم عناية' ),
        'Présentation fabrication et qualité Cosm’Éthique' => array( 'en' => 'Cosm’Éthique manufacturing and quality presentation', 'es' => 'Presentación de fabricación y calidad Cosm’Éthique', 'ar' => 'عرض التصنيع والجودة لكوزم إيثيك' ),
        'Fabrication & Qualité' => array( 'en' => 'Manufacturing & Quality', 'es' => 'Fabricación y Calidad', 'ar' => 'التصنيع والجودة' ),
        'Un processus clair, rigoureux et premium, de la sélection des actifs au conditionnement final de chaque soin.' => array( 'en' => 'A clear, rigorous and premium process, from active ingredient selection to the final packaging of each product.', 'es' => 'Un proceso claro, riguroso y premium, desde la selección de activos hasta el envasado final de cada producto.', 'ar' => 'عملية واضحة ودقيقة وفاخرة، من اختيار المكونات الفعالة إلى التغليف النهائي لكل منتج.' ),
        'Voir le processus' => array( 'en' => 'View the process', 'es' => 'Ver el proceso', 'ar' => 'عرض العملية' ),
        'Formulation précise' => array( 'en' => 'Precise formulation', 'es' => 'Formulación precisa', 'ar' => 'تركيبة دقيقة' ),
        'Conditionnement soigné' => array( 'en' => 'Careful packaging', 'es' => 'Envasado cuidado', 'ar' => 'تعبئة بعناية' ),
        'Fabrication responsable Cosm’Éthique' => array( 'en' => 'Responsible Cosm’Éthique manufacturing', 'es' => 'Fabricación responsable Cosm’Éthique', 'ar' => 'تصنيع مسؤول من كوزم إيثيك' ),
        'ATELIER QUALITÉ' => array( 'en' => 'QUALITY WORKSHOP', 'es' => 'TALLER DE CALIDAD', 'ar' => 'ورشة الجودة' ),
        'Chaque soin suit une méthode exigeante.' => array( 'en' => 'Every product follows a demanding method.', 'es' => 'Cada producto sigue un método exigente.', 'ar' => 'يتبع كل منتج منهجية صارمة.' ),
        'étapes suivies' => array( 'en' => 'tracked steps', 'es' => 'etapas seguidas', 'ar' => 'خطوات مُتابعة' ),
        'contrôlé' => array( 'en' => 'controlled', 'es' => 'controlado', 'ar' => 'مراقب' ),
        'Points forts Cosm’Éthique' => array( 'en' => 'Cosm’Éthique highlights', 'es' => 'Puntos fuertes Cosm’Éthique', 'ar' => 'نقاط قوة كوزم إيثيك' ),
        ...
        'Conseils et accompagnement Cosm’Éthique' => array( 'en' => 'Cosm’Éthique advice and support', 'es' => 'Consejos y acompañamiento Cosm’Éthique', 'ar' => 'نصائح ودعم كوزم إيثيك' ),
        'Toutes les réponses pour profiter pleinement de votre expérience Cosm’Éthique.' => array( 'en' => 'All the answers you need to fully enjoy your Cosm’Éthique experience.', 'es' => 'Todas las respuestas para disfrutar plenamente de tu experiencia Cosm’Éthique.', 'ar' => 'كل الإجابات للاستمتاع الكامل بتجربتك مع كوزم إيثيك.' ),
        'Aide Cosm’Éthique' => array( 'en' => 'Cosm’Éthique help', 'es' => 'Ayuda Cosm’Éthique', 'ar' => 'مساعدة كوزم إيثيك' ),
        'Réponses rapides' => array( 'en' => 'Quick answers', 'es' => 'Respuestas rápidas', 'ar' => 'إجابات سريعة' ),
        'Conseils produits' => array( 'en' => 'Product advice', 'es' => 'Consejos de producto', 'ar' => 'نصائح المنتجات' ),
        'CENTRE D’AIDE' => array( 'en' => 'HELP CENTRE', 'es' => 'CENTRO DE AYUDA', 'ar' => 'مركز المساعدة' ),
        'Une réponse claire à chaque étape.' => array( 'en' => 'A clear answer at every step.', 'es' => 'Una respuesta clara en cada etapa.', 'ar' => 'إجابة واضحة في كل خطوة.' ),
        'clientes accompagnées' => array( 'en' => 'customers supported', 'es' => 'clientas acompañadas', 'ar' => 'عميلات تمت مساعدتهن' ),
        'Réponse rapide' => array( 'en' => 'Quick answer', 'es' => 'Respuesta rápida', 'ar' => 'إجابة سريعة' ),
        'FAQ & contact' => array( 'en' => 'FAQ & contact', 'es' => 'FAQ y contacto', 'ar' => 'الأسئلة والتواصل' ),
        'Rechercher dans l’aide' => array( 'en' => 'Search the help centre', 'es' => 'Buscar en la ayuda', 'ar' => 'البحث في مركز المساعدة' ),
        'Une réponse claire, rapide et pensée pour vous.' => array( 'en' => 'A clear, quick answer designed for you.', 'es' => 'Una respuesta clara, rápida y pensada para ti.', 'ar' => 'إجابة واضحة وسريعة مصممة لك.' ),
        'Suggestions rapides' => array( 'en' => 'Quick suggestions', 'es' => 'Sugerencias rápidas', 'ar' => 'اقتراحات سريعة' ),
        'peau sensible' => array( 'en' => 'sensitive skin', 'es' => 'piel sensible', 'ar' => 'بشرة حساسة' ),
        'retour' => array( 'en' => 'return', 'es' => 'devolución', 'ar' => 'إرجاع' ),
        'Catégories d’aide' => array( 'en' => 'Help categories', 'es' => 'Categorías de ayuda', 'ar' => 'فئات المساعدة' ),
        'Choisissez un thème pour accéder directement aux questions associées.' => array( 'en' => 'Choose a topic to go directly to the related questions.', 'es' => 'Elige un tema para acceder directamente a las preguntas asociadas.', 'ar' => 'اختر موضوعاً للوصول مباشرة إلى الأسئلة المرتبطة.' ),
        'Choisissez votre sujet, trouvez la bonne réponse.' => array( 'en' => 'Choose your topic, find the right answer.', 'es' => 'Elige tu tema y encuentra la respuesta adecuada.', 'ar' => 'اختر موضوعك واعثر على الإجابة المناسبة.' ),
        '%d question' => array( 'en' => '%d question', 'es' => '%d pregunta', 'ar' => '%d سؤال' ),
        '%d questions' => array( 'en' => '%d questions', 'es' => '%d preguntas', 'ar' => '%d أسئلة' ),
        'Voir les réponses' => array( 'en' => 'View answers', 'es' => 'Ver respuestas', 'ar' => 'عرض الإجابات' ),
        'Délais, frais et suivi de livraison.' => array( 'en' => 'Delivery times, fees and tracking.', 'es' => 'Plazos, costes y seguimiento de envío.', 'ar' => 'مواعيد التوصيل والتكاليف والتتبع.' ),
        'Validation, modification et historique de commande.' => array( 'en' => 'Order confirmation, changes and history.', 'es' => 'Validación, modificación e historial del pedido.', 'ar' => 'تأكيد الطلب وتعديله وسجله.' ),
        'Moyens de paiement et sécurité.' => array( 'en' => 'Payment methods and security.', 'es' => 'Métodos de pago y seguridad.', 'ar' => 'طرق الدفع والأمان.' ),
        'Compte client' => array( 'en' => 'Customer account', 'es' => 'Cuenta cliente', 'ar' => 'حساب العميل' ),
        'Connexion, données et espace personnel.' => array( 'en' => 'Login, data and personal area.', 'es' => 'Conexión, datos y espacio personal.', 'ar' => 'تسجيل الدخول والبيانات والمساحة الشخصية.' ),
        'Conseils, compositions et types de peau.' => array( 'en' => 'Advice, formulas and skin types.', 'es' => 'Consejos, composiciones y tipos de piel.', 'ar' => 'نصائح وتركيبات وأنواع البشرة.' ),
        'Routine personnalisée et recommandations.' => array( 'en' => 'Personalised routine and recommendations.', 'es' => 'Rutina personalizada y recomendaciones.', 'ar' => 'روتين مخصص وتوصيات.' ),
        'Ouvrir une boutique Cosm’Éthique.' => array( 'en' => 'Open a Cosm’Éthique store.', 'es' => 'Abrir una tienda Cosm’Éthique.', 'ar' => 'افتح متجر كوزم إيثيك.' ),
        'Conditions et délais de retour.' => array( 'en' => 'Return conditions and deadlines.', 'es' => 'Condiciones y plazos de devolución.', 'ar' => 'شروط ومواعيد الإرجاع.' ),
        'Toutes vos questions' => array( 'en' => 'All your questions', 'es' => 'Todas tus preguntas', 'ar' => 'كل أسئلتك' ),
        'Des réponses détaillées, organisées par sujet.' => array( 'en' => 'Detailed answers, organised by topic.', 'es' => 'Respuestas detalladas, organizadas por tema.', 'ar' => 'إجابات مفصلة منظمة حسب الموضوع.' ),
        'Parcourez les thèmes essentiels pour commander, choisir vos soins, gérer votre compte ou préparer votre projet franchise.' => array( 'en' => 'Browse the key topics to order, choose your products, manage your account or prepare your franchise project.', 'es' => 'Explora los temas esenciales para comprar, elegir tus cuidados, gestionar tu cuenta o preparar tu proyecto de franquicia.', 'ar' => 'تصفح المواضيع الأساسية للطلب واختيار منتجاتك وإدارة حسابك أو تحضير مشروع الامتياز.' ),
        'Les plus consultées' => array( 'en' => 'Most viewed', 'es' => 'Las más consultadas', 'ar' => 'الأكثر مشاهدة' ),
        'Les réponses que nos clientes consultent le plus souvent.' => array( 'en' => 'The answers our customers view most often.', 'es' => 'Las respuestas que nuestras clientas consultan con más frecuencia.', 'ar' => 'الإجابات التي تطلع عليها عميلاتنا غالباً.' ),
        'Peaux sensibles' => array( 'en' => 'Sensitive skin', 'es' => 'Pieles sensibles', 'ar' => 'البشرة الحساسة' ),
        'Les fiches produits précisent les conseils adaptés aux peaux délicates.' => array( 'en' => 'Product pages specify advice suited to delicate skin.', 'es' => 'Las fichas de producto indican consejos adaptados a las pieles delicadas.', 'ar' => 'توضح صفحات المنتجات النصائح المناسبة للبشرة الحساسة.' ),
        'Conseillère Cosm’Éthique et produits premium' => array( 'en' => 'Cosm’Éthique advisor and premium products', 'es' => 'Asesora Cosm’Éthique y productos premium', 'ar' => 'مستشارة كوزم إيثيك ومنتجات فاخرة' ),
        'Vous ne trouvez pas votre réponse ?' => array( 'en' => 'Can’t find your answer?', 'es' => '¿No encuentras tu respuesta?', 'ar' => 'لا تجد إجابتك؟' ),
        'Comment suivre ma livraison ?' => array( 'en' => 'How can I track my delivery?', 'es' => '¿Cómo puedo seguir mi entrega?', 'ar' => 'كيف يمكنني تتبع التوصيل؟' ),
        'Le lien de suivi est disponible dans votre espace client dès l’expédition de la commande.' => array( 'en' => 'The tracking link is available in your customer account as soon as the order ships.', 'es' => 'El enlace de seguimiento está disponible en tu cuenta en cuanto se envía el pedido.', 'ar' => 'يتوفر رابط التتبع في حسابك بمجرد شحن الطلب.' ),
        'Où retrouver ma facture ?' => array( 'en' => 'Where can I find my invoice?', 'es' => '¿Dónde encuentro mi factura?', 'ar' => 'أين أجد فاتورتي؟' ),
        'Les documents liés à vos commandes sont accessibles depuis votre espace client.' => array( 'en' => 'Documents related to your orders are available from your customer account.', 'es' => 'Los documentos relacionados con tus pedidos están disponibles en tu cuenta cliente.', 'ar' => 'تتوفر المستندات المرتبطة بطلباتك من حساب العميل.' ),
        'Quels moyens de paiement sont acceptés ?' => array( 'en' => 'Which payment methods are accepted?', 'es' => '¿Qué métodos de pago se aceptan?', 'ar' => 'ما طرق الدفع المقبولة؟' ),
        'Le site présente les solutions disponibles directement dans le tunnel de commande.' => array( 'en' => 'The site displays available solutions directly during checkout.', 'es' => 'El sitio muestra las soluciones disponibles directamente en el proceso de compra.', 'ar' => 'يعرض الموقع الحلول المتاحة مباشرة أثناء إتمام الطلب.' ),
        'Puis-je modifier mes informations ?' => array( 'en' => 'Can I edit my information?', 'es' => '¿Puedo modificar mi información?', 'ar' => 'هل يمكنني تعديل معلوماتي؟' ),
        'Vos informations personnelles peuvent être mises à jour depuis la rubrique dédiée de votre espace client.' => array( 'en' => 'Your personal information can be updated from the dedicated section of your customer account.', 'es' => 'Tus datos personales pueden actualizarse desde la sección dedicada de tu cuenta cliente.', 'ar' => 'يمكن تحديث معلوماتك الشخصية من القسم المخصص في حساب العميل.' ),
        'Comment choisir ma routine ?' => array( 'en' => 'How do I choose my routine?', 'es' => '¿Cómo elegir mi rutina?', 'ar' => 'كيف أختار روتيني؟' ),
        'Le diagnostic beauté vous oriente vers les soins les plus adaptés à vos besoins.' => array( 'en' => 'The beauty diagnostic guides you toward the products best suited to your needs.', 'es' => 'El diagnóstico de belleza te orienta hacia los cuidados más adaptados a tus necesidades.', 'ar' => 'يوجهك تشخيص الجمال نحو المنتجات الأنسب لاحتياجاتك.' ),
        'Les recommandations sont-elles personnalisées ?' => array( 'en' => 'Are the recommendations personalised?', 'es' => '¿Las recomendaciones son personalizadas?', 'ar' => 'هل التوصيات مخصصة؟' ),
        'Les produits proposés dépendent des réponses données pendant le diagnostic.' => array( 'en' => 'Suggested products depend on the answers given during the diagnostic.', 'es' => 'Los productos propuestos dependen de las respuestas dadas durante el diagnóstico.', 'ar' => 'تعتمد المنتجات المقترحة على الإجابات المقدمة أثناء التشخيص.' ),
        'Puis-je proposer ma ville ?' => array( 'en' => 'Can I suggest my city?', 'es' => '¿Puedo proponer mi ciudad?', 'ar' => 'هل يمكنني اقتراح مدينتي؟' ),
        'Oui, le formulaire permet d’indiquer la ville souhaitée pour votre projet.' => array( 'en' => 'Yes, the form lets you indicate the desired city for your project.', 'es' => 'Sí, el formulario permite indicar la ciudad deseada para tu proyecto.', 'ar' => 'نعم، يتيح النموذج تحديد المدينة المطلوبة لمشروعك.' ),
        'Comment demander un retour ?' => array( 'en' => 'How do I request a return?', 'es' => '¿Cómo solicitar una devolución?', 'ar' => 'كيف أطلب الإرجاع؟' ),
        'Contactez notre équipe avec votre numéro de commande afin d’être accompagné.' => array( 'en' => 'Contact our team with your order number to be assisted.', 'es' => 'Contacta con nuestro equipo con tu número de pedido para recibir ayuda.', 'ar' => 'تواصل مع فريقنا ومعك رقم الطلب للحصول على المساعدة.' ),
        ...
        'Une beauté plus responsable.' => array( 'en' => 'More responsible beauty.', 'es' => 'Una belleza más responsable.', 'ar' => 'جمال أكثر مسؤولية.' ),
        'Cosm’Éthique imagine des soins premium qui respectent la peau, la nature et les gestes du quotidien. Chaque formule, chaque texture et chaque packaging répond à une exigence simple : faire mieux, avec élégance.' => array( 'en' => 'Cosm’Éthique imagines premium skincare that respects skin, nature and everyday rituals. Every formula, texture and packaging choice follows one simple standard: doing better, elegantly.', 'es' => 'Cosm’Éthique imagina cuidados premium que respetan la piel, la naturaleza y los gestos diarios. Cada fórmula, textura y envase responde a una exigencia sencilla: hacerlo mejor, con elegancia.', 'ar' => 'تبتكر كوزم إيثيك عناية فاخرة تحترم البشرة والطبيعة وطقوس الحياة اليومية. كل تركيبة وقوام وعبوة تستجيب لمعيار بسيط: فعل الأفضل بأناقة.' ),
        'Découvrir nos engagements' => array( 'en' => 'Discover our commitments', 'es' => 'Descubrir nuestros compromisos', 'ar' => 'اكتشف التزاماتنا' ),
        'Produits Cosm’Éthique engagés' => array( 'en' => 'Committed Cosm’Éthique products', 'es' => 'Productos comprometidos Cosm’Éthique', 'ar' => 'منتجات كوزم إيثيك الملتزمة' ),
        'Sélection de produits Cosm’Éthique' => array( 'en' => 'Cosm’Éthique product selection', 'es' => 'Selección de productos Cosm’Éthique', 'ar' => 'مجموعة منتجات كوزم إيثيك' ),
        'Baume corps Cosm’Éthique' => array( 'en' => 'Cosm’Éthique body balm', 'es' => 'Bálsamo corporal Cosm’Éthique', 'ar' => 'بلسم جسم كوزم إيثيك' ),
        'Routine premium Cosm’Éthique' => array( 'en' => 'Cosm’Éthique premium routine', 'es' => 'Rutina premium Cosm’Éthique', 'ar' => 'روتين كوزم إيثيك الفاخر' ),
        'Nos valeurs' => array( 'en' => 'Our values', 'es' => 'Nuestros valores', 'ar' => 'قيمنا' ),
        'Des engagements visibles dans chaque détail.' => array( 'en' => 'Commitments visible in every detail.', 'es' => 'Compromisos visibles en cada detalle.', 'ar' => 'التزامات تظهر في كل تفصيل.' ),
        'Tests sur les animaux' => array( 'en' => 'Animal testing', 'es' => 'Pruebas en animales', 'ar' => 'اختبارات على الحيوانات' ),
        'Clients satisfaits' => array( 'en' => 'Satisfied customers', 'es' => 'Clientes satisfechos', 'ar' => 'عملاء راضون' ),
        'Notre engagement en action' => array( 'en' => 'Our commitment in action', 'es' => 'Nuestro compromiso en acción', 'ar' => 'التزامنا في التطبيق' ),
        'Faire mieux, à chaque étape.' => array( 'en' => 'Doing better, at every step.', 'es' => 'Hacerlo mejor, en cada etapa.', 'ar' => 'فعل الأفضل في كل مرحلة.' ),
        'Nos priorités' => array( 'en' => 'Our priorities', 'es' => 'Nuestras prioridades', 'ar' => 'أولوياتنا' ),
        'Une exigence responsable, pensée pour durer.' => array( 'en' => 'Responsible standards designed to last.', 'es' => 'Una exigencia responsable pensada para durar.', 'ar' => 'معايير مسؤولة مصممة لتدوم.' ),
        'Protection de la planète' => array( 'en' => 'Protecting the planet', 'es' => 'Protección del planeta', 'ar' => 'حماية الكوكب' ),
        'Réduire le superflu, choisir des matières cohérentes et encourager des gestes plus conscients.' => array( 'en' => 'Reducing the unnecessary, choosing coherent materials and encouraging more conscious gestures.', 'es' => 'Reducir lo superfluo, elegir materiales coherentes y fomentar gestos más conscientes.', 'ar' => 'تقليل الزائد واختيار مواد منسجمة وتشجيع عادات أكثر وعياً.' ),
        'Respect de la peau' => array( 'en' => 'Respect for skin', 'es' => 'Respeto de la piel', 'ar' => 'احترام البشرة' ),
        'Des formules pensées pour le confort, la douceur et une routine lisible.' => array( 'en' => 'Formulas designed for comfort, softness and a clear routine.', 'es' => 'Fórmulas pensadas para el confort, la suavidad y una rutina clara.', 'ar' => 'تركيبات مصممة للراحة والنعومة وروتين واضح.' ),
        'Innovation' => array( 'en' => 'Innovation', 'es' => 'Innovación', 'ar' => 'الابتكار' ),
        'Associer actifs naturels, textures modernes et expérience premium.' => array( 'en' => 'Combining natural active ingredients, modern textures and a premium experience.', 'es' => 'Combinar activos naturales, texturas modernas y experiencia premium.', 'ar' => 'الجمع بين المكونات الطبيعية والقوام الحديث والتجربة الفاخرة.' ),
        'Qualité' => array( 'en' => 'Quality', 'es' => 'Calidad', 'ar' => 'الجودة' ),
        'Contrôler chaque étape pour proposer des soins réguliers, sûrs et agréables.' => array( 'en' => 'Controlling every step to offer consistent, safe and pleasant products.', 'es' => 'Controlar cada etapa para ofrecer cuidados constantes, seguros y agradables.', 'ar' => 'مراقبة كل مرحلة لتقديم منتجات ثابتة وآمنة وممتعة.' ),
        'Expliquer clairement les bénéfices, les usages et les choix de formulation.' => array( 'en' => 'Clearly explaining benefits, uses and formulation choices.', 'es' => 'Explicar claramente los beneficios, usos y elecciones de formulación.', 'ar' => 'شرح الفوائد والاستخدامات وخيارات التركيب بوضوح.' ),
        'Produits Cosm’Éthique sur fond premium' => array( 'en' => 'Cosm’Éthique products on a premium background', 'es' => 'Productos Cosm’Éthique sobre fondo premium', 'ar' => 'منتجات كوزم إيثيك على خلفية فاخرة' ),
        'La beauté responsable commence par des choix exigeants.' => array( 'en' => 'Responsible beauty begins with exacting choices.', 'es' => 'La belleza responsable empieza con decisiones exigentes.', 'ar' => 'يبدأ الجمال المسؤول باختيارات عالية المعايير.' ),
        ...
        'Soins naturels premium pour une beauté plus consciente.' => array( 'en' => 'Premium natural skincare for more conscious beauty.', 'es' => 'Cuidados naturales premium para una belleza más consciente.', 'ar' => 'عناية طبيعية فاخرة لجمال أكثر وعياً.' ),
